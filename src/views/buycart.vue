...
#buycart .cartItem .van-checkbox {
  margin: 0 5px;
}
#buycart .cartItem .van-image {
  background: #efefef;
}
#buycart .cartItem .proBrief {
  flex: 1;
  display: flex;
...
#buycart .cartItem .proBrief .title {
  width: 100%;
  font-size: 14px;
  display: flex;
  justify-content: space-between;
}
#buycart .cartItem .proBrief .brief {
  color: #999;
  font-size: 12px;
}

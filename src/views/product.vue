...
#product .proInfo .title {
  font-weight: 500;
  padding: 10px 0 5px;
}
#product .proInfo .brief {
  font-size: 12px;
  color: #999;
  padding: 3px;
}
#product .proInfo .price {
  font-size: 16px;
  color: red;
  padding: 5px;
}
#product .van-cell__title {
  text-align: left;
}
#product .proParams {
  padding-bottom: 20px;
}
#product .proParams h3 {
  padding: 10px 0;
}
#product .proParams .proItem {
  width: 90%;
  margin: 0 auto;
  display: flex;
...
#product .proParams .proItem span.title {
  width: 45px;
  padding: 0 10px;
  border-right: 1px solid #ccc;
}
#product .proParams .proItem span.value {
  width: 260px;
  overflow: hidden;

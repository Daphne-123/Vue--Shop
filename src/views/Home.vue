...
<style>
  ...
  #home .brandlist .van-grid-item__content {
    padding: 0;
  }
  #home .brandlist .van-image {
    border: 1px solid #fff;
  }
  #home .brandlist .title {
    position: absolute;
    top: -10px;
    left: 10px;
  }
  #home .brandlist .price {
    position: absolute;
    top: 30px;
    left: 10px;
    font-size: 14px;
  ...
  #home .hotlist .van-card__content {
    justify-content: center;
    text-align: left;
  }
  #home .hotlist .van-card__title {
    font-weight: 900;
    color: #333;
    font-size: 14px;
    padding: 5px 0;
  }
  #home .hotlist .van-card__price {
    color: red;
  }
